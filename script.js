...
const helpContent = {
	shellType: {
		...
		body: 'Tùy chọn các loại pháo hoa mà chú em yêu thích, nên chọn ngẫu nhiên để có trải nghiệm tốt nhất!!'
	},
	shellSize: {
		header: 'Kích cỡ pháo hoa',
		body: 'Tùy chỉnh kích cỡ pháo hoa khi được bắn ra, nên cân nhắc về độ lớn của pháo hoa vì có thể xảy ra giật lag!!'
	},
	quality: {
		header: 'Chất lượng pháo',
		body: 'Điều chỉnh độ mượt mà của báo khi bắn và nổ, cân nhắc việc chọn độ mượt, giật lag ráng chịu!!'
	},
	skyLighting: {
		header: 'Ánh sáng bầu trời',
		body: 'Điều chỉnh ánh sáng cảu bầu trời khi pháo hoa nổ, có thể chọn chỉ sáng mờ hoặc sáng rực theo ý thích nhằm tăng trải nghiệm!!!'
	},
	scaleFactor: {
		header: 'Tỉ lệ màn hình',
		body: 'Điều chỉnh zoom xa gần cho màn hình của bạn để nhìn pháo hoa rõ hơn, tùy theo kích cỡ màn hình:vv'
	},
	autoLaunch: {
		header: 'Tự động bắn (Bắn ít)',
		body: 'Pháo sẽ được bắn tự động mà không cần chạm tay hay click chuột vào màn hình, nhưng với cường độ ít!!'
	},
	finaleMode: {
		header: 'Tự động bắn (Bắn nhiều)',
		body: '(Tính năng này chỉ được kích hoạt khi đã bật tính năng tự động bắn 1) Chế độ này pháo sẽ được tự động bắn nhưng với cường độ nhiều hơn, nên cân nhắc để tránh ảnh hưởng đến trải nghiệm!!'
	},
	hideControls: {
		header: 'Ẩn đi các nút điều khiển',
		body: 'Ẩn đi các nút điều khiển để cho 1 tầm nhìn full view!!'
	},
	fullscreen: {
		header: 'Toàn màn hình',
		body: 'Chủ yếu là để bật toàn màn hình cho điện thoại còn trên pc thì cứ F11 mà đấm :v!!'
	},
	longExposure: {
		header: 'Tạo ảnh nghệ thuật',
		body: 'Làm cho pháo khi giống như vệt mực trên màn hình, chủ yếu để tạo ảnh nghệ thuật!!'
	}
};
...
function init() {
	...
	setOptionsForSelect(appNodes.quality, [
		...
		{ label: 'Vừa', value: QUALITY_NORMAL },
